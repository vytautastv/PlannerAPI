  ...
  $(document).ready(function () {
    ...
    // Creates a variable and uses query selector to display current date and time
  ...
  // A function to loop over time blocks to retrieve and display data from local storage
